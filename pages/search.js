        ...
        <Wrapper>
            ...
            <InputContainer>
                ...
                <InputBoxes>
                    ...
                    <Input placeholder='Enter Drop Location' value={dropoff} onChange={(e) => setDropoff(e.target.value)} />
                </InputBoxes>
...
const Wrapper = tw.div`
   flex flex-col bg-gray-200 h-screen 
`

const ButtonContainer = tw.div`
    bg-white px-4 shadow-md cursor-pointer
`
